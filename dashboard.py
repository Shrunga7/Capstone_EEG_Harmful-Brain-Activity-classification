...
# ─────────────────────────────────────────────────────────────────────────────
# DASHBOARD HTML (Added LLM Box CSS, HTML, and JS Fetch)
# ─────────────────────────────────────────────────────────────────────────────
...
# /* --- NEW LLM LAYER CSS --- */
# .llm-box { margin: 0 16px 14px; padding: 12px 14px; background: rgba(255,255,255,0.02); border: 1px solid var(--bdr2); border-radius: 3px; flex-shrink: 0;}
# .llm-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px; }
# .llm-title { font-size: 9px; font-weight: 600; letter-spacing: .12em; color: var(--mut); text-transform: uppercase; }
# .btn-gen { background: var(--sz); color: #fff; border: none; padding: 5px 10px; border-radius: 2px; font-family: inherit; font-size: 8px; cursor: pointer; text-transform: uppercase; font-weight: 700; letter-spacing: .1em; transition: opacity 0.2s; }
# .btn-gen:hover { opacity: 0.8; }
# .btn-gen:disabled { background: var(--mut); cursor: not-allowed; }
# .llm-text { font-size: 11px; color: var(--txt); line-height: 1.5; min-height: 33px;}
# /* ------------------------ */
...
#         <span class="llm-title">Layperson Report</span>
#         <button class="btn-gen" id="btnGen" onclick="generateSummary()">Generate</button>
#       </div>
...
# function update(d){
#   curCls=d.predicted;
#   currentProbabilities=d.probabilities; // <-- NEW LLM STATE UPDATE
